...
(yas-define-snippets 'web-mode
                     '(("=" "<%= $0 %>" "<%= ... %>" nil nil nil
                        "/home/fedex/.emacs.d/snippets/web-mode/rr.yasnippet"
                        nil nil)
                       ("-" "<% $0 %>" "<% ... %>" nil nil nil
                        "/home/fedex/.emacs.d/snippets/web-mode/r.yasnippet"
                        nil nil)
                       ("ife"
                        "<% if $0 %>\n  \n<% else %>\n  \n<% end %>"
                        "ERB if else" nil nil nil
                        "/home/fedex/.emacs.d/snippets/web-mode/ife.yasnippet"
                        nil nil)
                       ("if" "<% if $0 %>\n  \n<% end %>" "ERB if" nil
                        nil nil
                        "/home/fedex/.emacs.d/snippets/web-mode/if.yasnippet"
                        nil nil)
                       ("html"
                        ...
                        "/home/fedex/.emacs.d/snippets/web-mode/html.yasnippet"
                        nil nil)
                       ("bi" "{{$0}}\n" "Handlebars" nil nil nil
                        "/home/fedex/.emacs.d/snippets/web-mode/handlebars.yasnippet"
                        nil nil)
                       ("end" "<% end %>$0" "ERB end" nil nil nil
                        "/home/fedex/.emacs.d/snippets/web-mode/end.yasnippet"
                        nil nil)
                       ("else" "<% else %>" "ERB else" nil nil nil
                        "/home/fedex/.emacs.d/snippets/web-mode/else.yasnippet"
                        nil nil)
                       ("each"
                        "<% $1.each do |$2| %>\n  $0\n<% end %>"
                        "ERB each" nil nil nil
                        "/home/fedex/.emacs.d/snippets/web-mode/each.yasnippet"
                        nil nil)))
