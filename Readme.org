...
#+begin_src emacs-lisp
  (use-package indent-bars
    ...
    :init
    ;; Depth-based shading: darker → slightly lighter
    (setq indent-bars-color
          '("#1e1e1e"
            "#242424"
            "#2a2a2a"
            "#303030")

          indent-bars-highlight-color "#3a3a3a"
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'consult
    (keymap-global-set "H-g" #'fiachetti/consult-ripgrep-project)
    (keymap-global-set "H-G" #'fiachetti/consult-ripgrep-dir))
#+end_src
